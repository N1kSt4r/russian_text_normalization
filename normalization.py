...
def number_to_ordinal(text, case='nominative'):
    ...
    ordinal_map = {
        ...
        'nominative_neuter': {
            'один': 'первое', 'два': 'второе', 'три': 'третье', 'четыре': 'четвертое', 'пять': 'пятое',
            'шесть': 'шестое', 'семь': 'седьмое', 'восемь': 'восьмое', 'девять': 'девятое',
...
def normalize_russian(
    ...
    genitive_ordinal_day_probability=0.5):
